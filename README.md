...
В проекте используется автоматическая генерация SDK и TS-типов на основе OpenAPI спецификации.

### Как обновить API-слой:
1. Получите актуальный файл спецификации от бэкенд-команды (`openapi.yaml`).
2. Положите файл в корень проекта.
3. Запустите команду генерации:
   ```bash
